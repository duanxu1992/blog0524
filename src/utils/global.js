...
import Vue from 'vue';
import MainGolbal from 'utils/global';
...
global.init = function () {
	return new Promise((resolve, reject) => {
		...
		axios.get(`submodule/${packageJson.name}/assets/config/config-${env}.json`).then((res) => {
			let params = res.data;
		...
		axios.get(`submodule/${packageJson.name}/assets/config/navHeight.json`).then((res) => {
